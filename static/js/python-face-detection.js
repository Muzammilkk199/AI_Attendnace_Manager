...
class PythonFaceDetection {
    constructor() {
        ...
        this.stabilityFrames = 3; // Frames to wait for stable detection
        this.stableFrames = 0;
        this.detectionFPS = 5; // 5 FPS for server communication
    ...
    createFaceBox(face, index) {
        ...
        faceInfo.innerHTML = `
            ...
            <span class="quality-score">${Math.round(face.quality_score * 100)}%</span>
        `;
