...
urlpatterns = [
    ...
    path('user-management/', controller.user_management, name='user_management'),
    ...
    path('student_details/', controller.student_details, name='student_details'),
    ...
    path('api/attendance/edit/<str:attendance_id>/', controller.edit_attendance, name='edit_attendance'),
    path('api/attendance/delete/<str:attendance_id>/', controller.delete_attendance, name='delete_attendance'),
    path("export/excel/", controller.export_attendance_excel, name="export_attendance_excel"),
